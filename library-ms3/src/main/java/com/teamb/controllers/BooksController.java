...
import com.teamb.models.Book;
import com.teamb.services.IBooksService;
...
public class BooksController implements IBooksController {
	...
	public Book findById(@PathVariable String bookName, @RequestHeader(value="Authorization") String auth) {
	...
	public boolean decreaseQuantity(@PathVariable String bookid, @RequestHeader(value="Authorization") String auth) {
	...
	public void increaseQuantity(@PathVariable String bookid, @RequestHeader(value="Authorization") String auth) {
