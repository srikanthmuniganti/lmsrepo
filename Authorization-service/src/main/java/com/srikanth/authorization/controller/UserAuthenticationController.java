...
public class UserAuthenticationController {
	...
	//@ModelAttribute("user")
	public ResponseEntity<Object> addUser(@RequestBody User user )/*(@RequestParam("user") String user1,@RequestParam("imageFile") MultipartFile  file) */throws IOException {
		...
		return new ResponseEntity<>(myUserDetailsService.addUser(user), HttpStatus.CREATED);
