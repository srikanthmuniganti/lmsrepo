package com.teamb.WalletMS.controller;
...
import com.teamb.WalletMS.exception.InsufficientBalanceException;
import com.teamb.WalletMS.models.Wallet;
import com.teamb.WalletMS.service.IWalletService;
...
public class WalletController implements IWalletController {
	...
	@Override
	@GetMapping("/{username}")
	public ResponseEntity<Wallet> getWallet(@RequestHeader("Authorization") String token ,@PathVariable String username){
	...
	public void deductWallet(@RequestHeader("Authorization") String token , @PathVariable String username ,@PathVariable int orderid ,@PathVariable String bookName,@PathVariable double fine) throws InsufficientBalanceException {
	...
	public ResponseEntity<Object> addToWallet(@RequestHeader("Authorization") String token , @PathVariable String username ,@PathVariable double amount) {
